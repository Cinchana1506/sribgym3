...
import { updateGymRequestByEmployee } from '../services/gymRegistrationService';

/**
 * Custom hook for updating gym requests by Employee
 * @returns {Object} - Hook state and functions
 */
const useUpdateGymRequestByEmployee = () => {
  ...
  const updateRequest = useCallback(async (requestData) => {
    ...
    try {
      const result = await updateGymRequestByEmployee(requestData);
...
export default useUpdateGymRequestByEmployee; 